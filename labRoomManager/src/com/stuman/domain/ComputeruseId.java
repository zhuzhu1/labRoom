...
public class ComputeruseId  implements java.io.Serializable {
    ...
    /** full constructor */
    public ComputeruseId(String stuId, String roomId, String computerId, Date startTime, Date endTime, String duration, Double cost) {
        this.stuId = stuId;
        this.roomId = roomId;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ComputeruseId) ) return false;
 ...
 && ( (this.getComputerId()==castOther.getComputerId()) || ( this.getComputerId()!=null && castOther.getComputerId()!=null && this.getComputerId().equals(castOther.getComputerId()) ) )
