...
<html>
	...
	<f:view>
		<div align="center">
			<br><br><br><br><br><br><br><br><br>更新班级
			<h:form>
			...
			<tr>
				...
				--%>
				<h:inputText id="id" value="#{classesBean.classes.id}" />
				</td>
			</tr>
			<tr>
				<td>
				...
				<h:selectOneListbox id="sex" size="１" value="#{classesBean.classes.teacher.id}">
			...
			<tr>
				...
				<h:selectOneListbox id="sex" size="１" value="#{classesBean.classes.course.id}">
			...
			<tr>
				...
				<h:selectOneListbox id="sex" size="１" value="#{classesBean.classes.roomId}">
			...
			<tr>
				...
				<h:selectOneListbox id="sex" size="１" value="#{classesBean.classes.courTime}">
				...
				<p>
					 <h:commandButton action="#{classesBean.editClasses}" id="Submit" value="确定" />
				</p>
			</h:form>
			<div align="left">
				<a href="getClass.faces"><font size="+1">&lt;&lt;Back</font></a>
			</div>
		</div>
		</f:view>
	</body>
