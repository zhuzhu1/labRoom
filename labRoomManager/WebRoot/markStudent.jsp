...
<html>
	...
	<body  background="images/image-top2.jpg" style="background-repeat:no-repeat"> 
		<center>
			<br><br><br><br><br><br><br><br><br>选报该课程的学生
		</center>
		...
		<div align="center">
			...
			<h:form>
				<h:dataTable id="items" 
				             value="#{classesBean.acceptStudent}" 
				             var="enrol"
							 border="1"
							 width="75%"
				             >
			    ...
			    <h:column>
				    ...
				    <h:commandLink value="打分" action="#{enrolBean.editEnrol}">
				         <f:param name="stuid" value="#{enrol.student.id}"/>
				         <f:param name="classid" value="#{enrol.classes.id}"/>
				    </h:commandLink>
				  </h:column>
