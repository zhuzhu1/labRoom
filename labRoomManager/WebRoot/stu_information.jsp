...
<div id="Function">
    <ul>
	    <li id="studentinfo"><a href="stu_information2.faces"><img src="images/personal.png"><br />基本信息查看</a></li>
	    <li id="teachinginfo"><a href="stu_passwordModify.faces"><img src="images/achievement.png"><br />密码修改</a></li>
	</ul>
</div>
<div class="Line"></div>
<div>
