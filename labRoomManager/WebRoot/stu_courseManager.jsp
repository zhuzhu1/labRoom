...
<div id="Function">
    <ul>
	    <li id="studentinfo"><a href="stu_courselook.faces"><img src="images/personal.png"><br />课程查看</a></li>
	    <li id="teachinginfo"><a href="stu_courselistlook.faces"><img src="images/achievement.png"><br />课表查询</a></li>
	</ul>
</div>
<div class="Line"></div>
<div>
