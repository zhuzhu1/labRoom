...
<div id="Function">
    <ul>
	    <li id="studentinfo"><a href="stu_userManager.faces"><img src="images/personal.png"><br />用户管理</a></li>
	    <li id="teachinginfo"><a href="stu_labRoomManager.faces"><img src="images/achievement.png"><br />机房管理</a></li>
	    <li id="electiveinfo"><a href="stu_courseManager.faces"><img src="images/elective.png"><br />实验课程管理</a></li>
	</ul>
</div>
<div class="Line"></div>
<div>
